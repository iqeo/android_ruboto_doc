...
/**
  ...
  TODO: handle cases where Ruboto doc is identical to Java doc -> "SAME" in Ruboto doc
  TODO: handle 50x errors and non-responsive server - responseText may be null ??
  TODO: integrate with nginx/unicorn? on server
  TODO: git repository at android_ruboto_doc root instead of docs dir ? - can use the same github repo for doc backup
...
var ruby_host_url = "http://android-ruboto-doc.iqeo.net:4567";
...
for ( var i = 0 ; i < pres.length; i++ ) {
  ...
  var ruby_url = ruby_host_url + "/data/" + doc_name;
  GM_xmlhttpRequest( {
    method:  "GET",
    url:     ruby_url,
    data:    "",
    ...
    onload:  function( response ) {
      ...
      switch( response.status ) {
        case 200:
          ...
          if ( ruby_text.length > 0 ) {
            ...
            edit_link.setAttribute( "href",   ruby_host_url + "/edit/" + doc_name );
            ...
            create_link.setAttribute( "href", ruby_host_url + "/create/" + doc_name );
      ...
      about_link.setAttribute( "href",   ruby_host_url + "/home" );
